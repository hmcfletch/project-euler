...
# number is Lychrel until proven otherwise. In addition you are given that for every
...
require './helpers/digits'

def lychrel?(n, max_iters=50)
  x = n
  y = Digits.reverse_number(n)
